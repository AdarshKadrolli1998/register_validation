...
class Bloc extends Object with Validators {
  ...
  Stream<String>get telephone => _telephone.stream.transform(validateTelephoneField);
  Stream<String> get name => _name.stream.transform(validateNameField);
  ...
  Stream<bool> get submitValid => Observable.combineLatest4(email, password, telephone, name, (e, p, t, n,) => true);
